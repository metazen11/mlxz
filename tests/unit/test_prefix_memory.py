...
class TestPrefixCacheMemory:
    ...
    def test_longest_prefix_matching(self):
        ...
        n_matched, kv_states, _ = cache.lookup_sync(long_hashes)
    ...
    def test_shared_prefix_boundary_is_cached(self):
        ...
        n_matched, kv_states, _ = cache.lookup_sync(prefix_hashes)
        assert n_matched == 4
        assert kv_states is not None
    ...
    def test_lru_eviction(self):
        ...
        n, _, _ = cache.lookup_sync(h1)
        assert n == 0
        # h2 should still exist
        n, _, _ = cache.lookup_sync(h2)
        assert n > 0
    ...
    def test_deep_copy_independence(self):
        ...
        _, cached, _ = cache.lookup_sync(hashes)
